...
class Settings extends CI_Controller {
	...
	public function edit_banner($id) {
       ...
       // $this->data['list_filter'] = $this->admin->categories_list();
        ...
        if ($this->input->post()) {
			$inp=$this->input->post();//echo '<pre>';print_r($inp);//echo '<pre>';print_r($_FILES);exit;
			...
			if($this->input->post('bgimg_for')=='banner' || $this->input->post('bgimg_for')=='bottom_image1' || $this->input->post('bgimg_for')=='bottom_image2' || $this->input->post('bgimg_for')=='bottom_image3'){
				//$data['bgimg_for'] = $this->input->post('bgimg_for');
				...
				if($this->input->post('bgimg_for')=='banner' || $this->input->post('bgimg_for')=='bottom_image1' || $this->input->post('bgimg_for')=='bottom_image2' || $this->input->post('bgimg_for')=='bottom_image3')
				{
					if (isset($_FILES) && !empty($_FILES['upload_image']['name'])) {
						...
						//$src3          = 'uploads/banners/';
						move_uploaded_file($av_file['tmp_name'], $src2);
						//$medium_image = $this->image_resize('256', '256', $src3, $image_name);
