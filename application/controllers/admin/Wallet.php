...
class Wallet extends CI_Controller {
  ...
  public function getProivdierBankDetails() {
    ...
    $bank_details = $this->db->select('account_holder_name,account_number,account_iban,bank_name, bank_address,sort_code,routing_number,account_ifsc')->get_where('providers', array('id'=>$provider_id))->row();
    //$bank_details = $this->db->get_where('providers', array('id'=>$provider_id))->row();
