...
$this->data['razorpay'] = $this->db->from('razorpay_gateway')->where('gateway_type', $razorpay_type)->get()->row();

$this->data['paypal'] =  $this->db->from('paypal_payment_gateways')->where('gateway_type', $paypal_type)->get()->row();

$this->data['stripe'] =  $this->db->from('payment_gateways')->where('gateway_type', $stripe_type)->get()->row();
...
public function service_map_list(){
  ...
  print($data);
    ...
    public function user_favorites()
    {
        ...
        //var_dump($this->data['all_favorites']); exit();
        // Load the list page view 
        $this->load->vars($this->data);
        $this->load->view($this->data['theme'].'/template');
    }
