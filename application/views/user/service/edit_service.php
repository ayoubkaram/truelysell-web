                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="service_title" id="service_title" value="<?php echo $services['service_title']; ?>">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
...
for ($i = 0; $i < count($service_image); $i++) {
    ...
    //echo 'img<pre>'; print_r($service_image); exit;
    ?>
                                            <li id="service_img_<?php echo $service_image[$i]['id']; ?>">
                                                <div class="upload-images">

                                                    <a href="javascript:void(0);" class="file_close1 btn btn-icon btn-danger btn-sm" onclick="delete_img(<?php echo $service_image[$i]['id']; ?>)">X</a><img alt="Service Image" src="<?php echo base_url() . $service_image[$i]['service_image']; ?>">
                                                </div>
                                            </li>
                                        <?php } ?>
                                    </ul>
