				...
				<!--a href="<?php echo base_url();?>search/<?php echo str_replace(' ', '-', $category_name);?>"-->
					<div class="cate-widget">
						...
						<div class="cate-count">
							<a class="text-white" href="<?php echo base_url();?>search/<?php echo str_replace(' ', '-', $crowcategory)?>/<?php echo str_replace(' ', '-', $category_name)?>"><i class="fas fa-clone"></i> <?php echo $crows['category_count'];?></a>
						</div>
					</div>
				<!--/a-->
			</div>
