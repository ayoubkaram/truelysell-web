									...
									<div class="form-group">
										<div id="payment-method">
											<div class="row">
                                                ...
                                                <div class="col-4">
                                                    <span>
                                                    <input type="radio" id="gigs_payment_radio6" name="group2" value="RazorPay" checked>
                                ...
                                <?php } else { ?>
                                    ...
                                    <thead>
                                        <tr>
											...
											<th><?php echo (!empty($user_language[$user_selected]['lg_type'])) ? $user_language[$user_selected]['lg_type'] : $default_language['en']['lg_type']; ?></th>
                                        ...
                                        if (!empty($wallet_history)) {
                                            ...
                                            foreach ($wallet_history as $key => $value) {
                                                if (!empty($value['credit_wallet'])) {
                                                    ...
                                                    $color = 'danger';
                                                    $message = (!empty($user_language[$user_selected]['lg_Completed'])) ? $user_language[$user_selected]['lg_Completed'] : $default_language['en']['lg_Completed'];'Debit';
                                                }
