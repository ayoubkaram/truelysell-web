                            ...
                            if (!empty($all_favorites)) { 
                                ...
                                foreach ($all_favorites as $favorites) { 
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo "<a target='_blank' href='".$base_url."service-preview/".str_replace(' ', '-', strtolower($favorites['service_title'])) . '?sid=' . md5($favorites['service_id'])."' alt='view' class='mr-2'><i class='far fa-eye mr-1'> ".$view."</i></a>"; ?></td>
                                    </tr>
                                <?php $i++; } //foreach end
                            } //if empty end
                            else{ ?>
