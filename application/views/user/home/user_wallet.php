        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-md-8">
                ...
                <div class="row">
					...
					//echo "<pre>";print_r(currency_conversion($user_currency_code));//exit;
                    ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="wallet-details">
                                    ...
                                    <div class="d-flex justify-content-between my-4">
                                        <div>
                                            <p class="mb-1"><?php echo (!empty($user_language[$user_selected]['lg_Total_Credit'])) ? $user_language[$user_selected]['lg_Total_Credit'] : $default_language['en']['lg_Total_Credit']; ?><?php //print_r($userId);exit;?></p>
...
?>
    ...
    <script>
        ...
        $('#stripe').click(function(){
            ...
            if($stripe == 'stripe'){
                $('#stripe_wallet').show();
                $('#stripe_wallet').css('background','#0400ff');
                $('#stripe_wallet').css('border','1px solid #0400ff');
