                            ...
                            <div class="bookings">
                                <div class="booking-list">
                                                    ...
                                                    <?php
                                                        ...
                                                        if($this->session->userdata('usertype') == "provider") { 
                                                            if($userId && ($userId == $blocked_user['blocked_by_id']) && ($bookings['user_id'] == $blocked_user['blocked_id']) ) {
                                                                if($blocked_user['status'] == 1) { ?>
                                                                    <!-- <a href="javascript:;" class="blocking" style="float: right;" data-id="<?php echo $blocked_user['id']?>" data-blockedbyid = "<?php echo $userId?>" data-blockedid="<?php echo $blocked_user['blocked_id']?>" data-blockedstatus="0" data-usertype="2" ><span class='badge badge-pill badge-prof <?php echo $blk_class; ?>'><?= $blk_text; ?></span></a> -->
                                                                ...
                                                                <?php }
                                                                    ...
                                                                    <!--<a href="javascript:;" class="myBlockReasonModal" data-doggle="modal" data-target="#myBlockReasonModal" style="float: right;" data-id="<?php echo $blocked_user['id']?>" data-blockedbyid = "<?php echo $userId?>" data-blockedid="<?php echo $blocked_user['blocked_id']?>" data-blockedstatus="2" data-usertype="2"><span class='badge badge-pill badge-prof <?php echo $blk_class; ?>'><?= $blk_text; ?></span></a>-->
                                                                <?php } 
                                                            } else { ?>
                                                               <!-- <a href="javascript:;" class="myBlockReasonModal" data-doggle="modal" data-target="#myBlockReasonModal" style="float: right;" data-id="" data-blockedbyid = "<?php echo $this->session->userdata('id');?>" data-blockedid="<?php echo $bookings['user_id']?>" data-blockedstatus="2" data-usertype="2"><span class='badge badge-pill badge-prof bg-danger'><?= "Report User" ?></span></a>-->
                                                            <?php }
                                                        }
                                                    ?>
                                    ...
                                    <div class="booking-action">
                                        <?php if($blocked_user['status'] != 1) { //add new line?> 
