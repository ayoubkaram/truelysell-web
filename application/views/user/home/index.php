                            ...
                            <form action="<?php echo base_url(); ?>search" id="search_service" method="post">
                                ...
                                <div class="search-input line">
                                    ...
                                    <div class="form-group mb-0">
                                        <input type="text" class="form-control common_search" name="common_search" id="search-blk" placeholder="<?php echo (!empty($user_language[$user_selected]['lg_what_you_look'])) ? $user_language[$user_selected]['lg_what_you_look'] : $default_language['en']['lg_what_you_look']; ?>" >
                                    </div>
                                </div>
                            ...
                            foreach ($category as $crows) {
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <a href="<?php echo base_url(); ?>search/<?php echo str_replace(' ', '-', strtolower($crows['category_name'])); ?>">
										...
										<?php } else { ?>
											 <img alt="Category Image" src="https://via.placeholder.com/360x220.png?text=Category%20Image">
										<?php } ?>
                            ...
                            <div class="howwork">
                                <div class="iconround">
                                    <div class="steps">01</div>
										...
										if(!empty($bo1result[0]['upload_image'])){											
											echo '<img src="'.base_url().$bo1result[0]['upload_image'].'">';
										}else{
                                ...
                                <h3>
								<?php if(!empty($bo1result[0]['banner_content'])){											
									echo $bo1result[0]['banner_content'];
								}else{									
									echo 'Choose What To Do';
								}?>
								</h3>
                                <p>
								<?php if(!empty($bo1result[0]['banner_sub_content'])){											
									echo $bo1result[0]['banner_sub_content'];
								}else{									
									echo 'Aliquam lorem ante, dapibus in, viverra quis, feugiat Phasellus viverra nulla ut metus varius laoreet.';
								}?>
								</p>
                            </div>
                        </div>
                            ...
                            <div class="howwork">
                                <div class="iconround">
                                    ...
                                    <?php
										...
										if(!empty($bo2result[0]['upload_image'])){											
											echo '<img src="'.base_url().$bo2result[0]['upload_image'].'">';
										}else{
                                ...
                                <h3>
								<?php if(!empty($bo2result[0]['banner_content'])){											
									echo $bo2result[0]['banner_content'];
								}else{									
									echo 'Find What You Want';
								}?>
								</h3>
                                <p>
								<?php if(!empty($bo2result[0]['banner_sub_content'])){											
									echo $bo2result[0]['banner_sub_content'];
								}else{									
									echo 'Aliquam lorem ante, dapibus in, viverra quis, feugiat Phasellus viverra nulla ut metus varius laoreet.';
								}?>
								</p>
                            ...
                            <div class="howwork">
                                <div class="iconround">
                                    ...
                                    <?php
										...
										if(!empty($bo3result[0]['upload_image'])){											
											echo '<img src="'.base_url().$bo3result[0]['upload_image'].'">';
										}else{
                               ...
                               <h3>
								<?php if(!empty($bo3result[0]['banner_content'])){											
									echo $bo3result[0]['banner_content'];
								}else{									
									echo 'Amazing Places';
								}?>
								</h3>
                                <p>
								<?php if(!empty($bo3result[0]['banner_sub_content'])){											
									echo $bo3result[0]['banner_sub_content'];
								}else{									
									echo 'Aliquam lorem ante, dapibus in, viverra quis, feugiat Phasellus viverra nulla ut metus varius laoreet.';
								}?>
								</p>
