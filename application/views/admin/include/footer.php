...
data[keyname] = keyvalue;
      ...
      <?php } 
	   ...
	   if($page == 'contact-details'){
              ...
              bootbox.confirm("<h4>REPLY CONTACT</h4><br><textarea id='replycont' class='form-control' placeholder='REPLY...' rows='10'></textarea><span class='text-danger error_msg'></span> ", function (result) {
                if (result == true) {
