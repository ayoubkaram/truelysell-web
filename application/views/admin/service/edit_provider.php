					...
					<div class="card-body">
						<form id="add_provider" method="post" autocomplete="off" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<select class="form-control" name="category" id="admin_category">
									<option value="">Select Category</option>
									<?php foreach ($category as $key => $value) {?>
									<option value="<?=$value['id'];?>" <?php echo (!empty($user['category'])&&$user['category']==$value['id'])?'selected':''?>> <?=$value['category_name'];?></option>
								<?php } ?>
								</select>
							</div>
							...
							<?php }?>
								...
								<a href="<?php echo $base_url; ?>service-providers"  class="btn btn-link">Cancel</a>
							</div>
						</form>
					</div>
				</div>
