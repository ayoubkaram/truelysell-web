						...
						<form method="post" autocomplete="off" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="example1">
									...
									<div><input type="checkbox" name="accesscheck[]" id="check_2" value="2"> <label for="check_2">Provider</label></div>								
								</div>
							</div>
							<div class="mt-4">
								<?php if($user_role==1){?>
							...
							<?php }?>
								...
								<a href="<?php echo $base_url; ?>admin/SendPushNotification"  class="btn btn-link">Cancel</a>
							</div>
						</form>
					</div>
				</div>
