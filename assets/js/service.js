  ...
  function get_latitude_longitude() {
      ...
      if($('#add_service, #update_service').length > 0 ){
        ...
        function RenderThumbnail(e, readerEvt)
        {
          ...
          '<a style="display:none;" href="javascript:void(0);" class="file_close btn btn-icon btn-danger btn-sm">X</a><img class="thumb" src="', e.target.result, '" title="', escape(readerEvt.name), '" data-id="',
